...
return [
    ...
    */
    ...
    'custom_permissions' => [
        // PengirimanResource & PenjualanResource memakai model Penjualan yang sama,
        // sehingga permission model `:Penjualan` tidak bisa membedakan keduanya.
        // Dua izin khusus ini memisahkan akses antrian pengiriman dari resource penjualan.
        'LihatPengiriman' => 'Lihat Antrian Pengiriman',
        'KelolaPengiriman' => 'Kelola Pengiriman (assign sopir & ubah status)',
    ],
